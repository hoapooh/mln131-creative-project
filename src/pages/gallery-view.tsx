...
const galleryData: GalleryItem[] = [
	...
	},
	{
		...
		quote: "Tay bưng đĩa muối chấm gừng - Gừng cay muối mặn xin đừng bỏ nhau.",
	...
	},
	{
		...
		quote: "Dạy con đọc sách thánh hiền, còn hơn để lại bạc tiền đầy rương.",
		author: "Cổ ngữ",
	},
	{
		id: 6,
		...
		quote: "Anh em thuận hòa là nhà có phúc.",
		author: "Tục ngữ Việt Nam",
	},
	{
		id: 7,
		...
		quote: "Bốn phương sum họp một nhà - Miếng trầu lịch sự chén trà phong lưu.",
		author: "Ca dao Việt Nam",
	},
	{
		id: 8,
		...
		quote: "Cây xanh thì lá cũng xanh, cha mẹ hiền lành để phúc cho con.",
		author: "Tục ngữ Việt Nam",
	},
	{
		id: 9,
		...
		quote: "Con người có cố, có ông. Như cây có cội, như sông có nguồn.",
		author: "Tục ngữ Việt Nam",
	},
	{
		id: 10,
		...
		quote: "Tử hiếu song thân lạc, gia hòa vạn sự hưng.",
	...
	return (
		<div className="pt-[65px] min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50">
			<div className="max-w-7xl mx-auto px-4 py-12">
				...
				>
					<h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 bg-clip-text text-transparent leading-20">
						Thư viện ảnh
					</h1>
				...
				{isLoading ? (
					...
					<div className="columns-1 md:columns-2 lg:columns-3 gap-4 space-y-4">
						{Array.from({ length: 10 }).map((_, index) => (
							<div
								key={index}
								className="break-inside-avoid relative overflow-hidden rounded-2xl shadow-lg animate-pulse"
								style={{
									height: `${300 + Math.random() * 300}px`, // Random height between 300-600px
								}}
							>
